...
var changeModalState = function changeModalState(state) {
  var windowForm = document.querySelectorAll('.balcon_icons_img '),
      ...
      windowProfile = document.querySelectorAll('.checkbox'); //call function
...
var forms = function forms(state) {
  var form = document.querySelectorAll('form'),
      input = document.querySelectorAll('input'); //call function
...
var modals = function modals() {
  ...
  bindModal('.popup_calc_btn', '.popup_calc', '.popup_calc_close'); //inner modal calc cost

  bindModal('.popup_calc_button', '.popup_calc_profile', '.popup_calc_profile_close', false);
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); //call function showModalByTime
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  hideTabContent();
  showTabContent(); //Which tabs was click user
